...
| NSFSTS | Statistics | 8 | — |
| NSFDEV / NSFCTCI / NSFLCS / NSFHOST | Devices & drivers (NSFDEV table + DEVOPS + NSFHOST host driver, M1-2; CTCI top half `asm/nsfctcio.asm` + C lifecycle `src/nsfctci.c` M1-3, codec/DEVOPS bottom half M1-4) | 9 | 200–299 |
