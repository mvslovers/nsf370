//TSTAPPDL JOB (A),'NSF APP LEAVE',CLASS=A,MSGCLASS=H,
//             MSGLEVEL=(1,1),NOTIFY=&SYSUID
//*
//* M5-2c1 stage a -- the LEAVE arm: ends WITHOUT TERMAPI -- THE MAIN CASE, the mistake a
//* relink-only application actually makes.  Ends normally, CC 0.
//*
...
//* PREREQUISITE:  S NSFS
//*
//RUN     EXEC PGM=TSTAPPD,REGION=8M
