//TSTAPPDC JOB (A),'NSF APP CLEAN',CLASS=A,MSGCLASS=H,
//             MSGLEVEL=(1,1),NOTIFY=&SYSUID
//*
//* M5-2c1 stage a -- the CLEAN arm: ends WITH TERMAPI -- THE CONTROL.  Without it, "one slot in
//* use" after a LEAVE run is not evidence: it could be a registry that never
//* empties.  This arm is what makes the LEAVE reading mean something.
//*
...
//* PREREQUISITE:  S NSFS
//*
//RUN     EXEC PGM=TSTAPPD,PARM='CLEAN',REGION=8M
